...
class Parser:
    ...
    def parse(self):
        ...
        parser.add_argument(
            'payloadSize',
            type=int,
            help='int specifying the size in Bytes of the packets payload. Default is 1454',
            nargs='?',
            default=1454)
        parser.add_argument(
            'headerSize',
            type=int,
            help='int specifying the size in Bytes of the packets headers, Default is 46',
            nargs='?',
            default=46)
        parser.add_argument(
            'fileSize',
            type=int,
            help='int specifying the size in Bytes of the total data to be sent, Default is 10000000',
            nargs='?',
            default=10000000)
        parser.add_argument(
            'BER',
