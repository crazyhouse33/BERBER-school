...
class Parser:
    ...
    def parse(self):
        ...
        parser.add_argument('-payloadSize', type=int, help='int specifying the size in Bytes of the packets payload. Default is '+ str(defaultPS),  default=defaultPS)
        parser.add_argument('-headerSize', type=int, help='int specifying the size in Bytes of the packets headers, Default is '+ str(defaultHS), default=defaultHS)
        parser.add_argument('-fileSize', type=int, help='int specifying the size in Bytes of the total data to be sent, Default is '+ str(defaultFS), default=defaultFS)
